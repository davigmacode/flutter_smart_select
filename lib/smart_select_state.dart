...
typedef Widget SmartSelectBuilder(BuildContext context, SmartSelectState state, Function showOptions);
...
class SmartSelectState {
  ...
  dynamic get valueObject {
    return option.isMultiChoice
      ...
      : option.items.firstWhere((x) => x[option.value] == value, orElse: () => null);
  }
  ...
  dynamic get valueLabel {
    return option.isMultiChoice
      ? valueObject != null && valueObject.length > 0
        ...
        : null
      : valueObject != null
        ? valueObject[option.label]
        : null;
  }

  String get valueDisplay {
    return valueLabel != null
      ? option.isMultiChoice
        ? valueLabel.join(', ')
        : valueLabel
