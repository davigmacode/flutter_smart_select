...
abstract class S2State<T> extends State<SmartSelect<T>> {
  ...
  Widget get defaultModalFilter {
    return TextField(
      ...
      cursorColor: modalConfig.isFullPage ? Colors.white : theme.indicatorColor,
        ...
        return Center(
          child: Padding(
            ...
            child: TextButton(
              ...
              style: TextButton.styleFrom(
                  backgroundColor: modalConfig.confirmIsDark ? modalConfig.confirmColor ?? Colors.blueGrey : null,
                  textStyle: TextStyle(
                      color: modalConfig.confirmIsLight ? modalConfig.confirmColor : Colors.white
                  )
              ),
